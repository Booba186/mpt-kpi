<template>
	<section id="workspace">
		<div class="section-header">
			...
			<div class="add-certificate" @click="$emit('showAddCertificatePopup', true)">
				<add-icon />
			</div>
		</div>
		<div class="criterion-secition" v-for="criterion in extendedCriteriesList" :key="criterion.id">
...
export default {
	...
	computed: {
		extendedCriteriesList() {
			...
			return local_criteries.filter((criterion) => criterion.certificates.length !== 0)
		},
	},
	methods: {
